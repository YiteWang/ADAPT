...
from sparselearning.backbones.backbone_utils.model_ops import *
from sparselearning.backbones.backbone_utils.misc import *
...
class Generator(nn.Module):
    """Generator."""
    # def __init__(self, args, z_dim, shared_dim, img_size, g_conv_dim, g_spectral_norm, attention, attention_after_nth_gen_block, activation_fn,
    ...
    def forward(self, z, y, shared_label=None, evaluation=False):
        label = y
...
class Discriminator(nn.Module):
    """Discriminator."""
    # def __init__(self, args,img_size, d_conv_dim, d_spectral_norm, attention, attention_after_nth_dis_block, activation_fn, conditional_strategy,
