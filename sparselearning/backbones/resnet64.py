...
from .backbone_utils.base import GAN
from .backbone_utils.resblocks import ResBlock2d, ResBlock2d32Pix, FastResBlock2dDownsample
from .backbone_utils._int import FMAP_SAMPLES, RES_INIT
from .backbone_utils.custom_layers import Lambda, NormalizeLayer, Conv2dEx, LinearEx
...
class Generator64PixResnet( GAN ):
  ...
  def __init__( self, args):
    ...
    self.equalized_lr = equalized_lr
    print(len_latent, FMAP_G_INIT_64_FCTR,'what?')
